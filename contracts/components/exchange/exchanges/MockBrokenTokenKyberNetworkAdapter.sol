...
contract MockBrokenTokenKyberNetworkAdapter is OlympusExchangeAdapterInterface{
    ...
    bytes32 public name = "Mock Broken Token Kyber Network Adapter";
    ...
    external checkBrokenToken(_token) payable returns(bool) {
    ...
    external checkBrokenToken(_token) returns(bool success)
    {
    ...
    external checkBrokenToken(_dest) payable returns(bool success)
    {
